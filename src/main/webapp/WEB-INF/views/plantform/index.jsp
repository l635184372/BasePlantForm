            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${ctxStatic}/plantform/img/profile_small.jpg" /></span>
                    ...
                    <div class="logo-element">H+
                        ...
                        <c:forEach var="menu" items="${menuList}" varStatus="status">
                            <%--<c:if test="${menu.childrenList != null}">--%>
                            <c:choose>
                                <c:when test="${menu.childrenList != null && menu.childrenList.size() > 0}">
                                    <li>
                                        <a href="#">
                                            <i class="${menu.imgClass}"></i>
                                            <span class="nav-label">${menu.name}</span>
                                            <span class="fa arrow"></span>
                                        </a>
                                        <ul class="nav nav-second-level">
                                            <c:forEach items="${menu.childrenList}" var="secondMenu" varStatus="status">
                                                <li>
                                                    <a class="J_menuItem" href="${ctxSys}/${secondMenu.target}" >${secondMenu.name}</a>
                                                </li>
                                            </c:forEach>
                                        </ul>
                                    </li>
                                ...
                                <c:otherwise>
                                    <li>
                                        <a class="J_menuItem" href="${ctxSys}/${menu.target}"><i class="${menu.imgClass}"></i> <span class="nav-label">${menu.name}</span></a>
                                    </li>
                                </c:otherwise>
                            </c:choose>
                        </c:forEach>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-third-level">
                                <li>
                                    <a class="J_menuItem" href="icons.html" tppabs="http://www.zi-han.net/theme/hplus/icons.html">Font Awesome</a>
                                </li>
                                <li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li class="m-t-xs">
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" tppabs="http://www.zi-han.net/theme/hplus/profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${ctxStatic}/plantform/img/a7.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a7.jpg">
                                    </a>
                            ...
                            <li>
                                <div class="dropdown-messages-box">
                                    <a href="profile.html" tppabs="http://www.zi-han.net/theme/hplus/profile.html" class="pull-left">
                                        <img alt="image" class="img-circle" src="${ctxStatic}/plantform/img/a4.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a4.jpg">
                                    </a>
                                    <div class="media-body ">
                ...
                <div id="tab-1" class="tab-pane active">
                    ...
                    <div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctxStatic}/plantform/img/a1.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a1.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctxStatic}/plantform/img/a2.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a2.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctxStatic}/plantform/img/a3.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a3.jpg">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctxStatic}/plantform/img/a4.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a4.jpg">
                                </div>
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctxStatic}/plantform/img/a8.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a8.jpg">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="sidebar-message">
                            <a href="#">
                                <div class="pull-left text-center">
                                    <img alt="image" class="img-circle message-avatar" src="${ctxStatic}/plantform/img/a7.jpg" tppabs="http://www.zi-han.net/theme/hplus/img/a7.jpg">
                                </div>
                                <div class="media-body">
