    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="footer">
            <div class="pull-right">
                By：<a href="javascript:if(confirm('http://www.zi-han.net/  \n\nlδ Teleport Pro  ·’~okΧ  \n\nΘ'))window.location='http://www.zi-han.net/'"   target="_blank">zihan's blog</a>
            </div>
            <div>
...
<!-- Flot -->
<script src="${ctxStatic}/plantform/js/plugins/flot/jquery.flot.js"  ></script>
<script src="${ctxStatic}/plantform/js/plugins/flot/jquery.flot.tooltip.min.js"  ></script>
<script src="${ctxStatic}/plantform/js/plugins/flot/jquery.flot.resize.js"  ></script>

<!-- ChartJS-->
<script src="${ctxStatic}/plantform/js/plugins/chartJs/Chart.min.js"  ></script>

<!-- Peity -->
<script src="${ctxStatic}/plantform/js/plugins/peity/jquery.peity.min.js"  ></script>

<!-- Peity demo -->
<script src="${ctxStatic}/plantform/js/demo/peity-demo.min.js"  ></script>


<script>
    $(document).ready(function(){var f=[[1262304000000,6],[1264982400000,3057],[1267401600000,20434],[1270080000000,31982],[1272672000000,26602],[1275350400000,27826],[1277942400000,24302],[1280620800000,24237],[1283299200000,21004],[1285891200000,12144],[1288569600000,10577],[1291161600000,10295]];var e=[[1262304000000,5],[1264982400000,200],[1267401600000,1605],[1270080000000,6129],[1272672000000,11643],[1275350400000,19055],[1277942400000,30062],[1280620800000,39197],[1283299200000,37000],[1285891200000,27000],[1288569600000,21000],[1291161600000,17000]];var a=[{label:"数据1",data:f,color:"#17a084"},{label:"数据2",data:e,color:"#127e68"}];$.plot($("#flot-chart1"),a,{xaxis:{tickDecimals:0},series:{lines:{show:true,fill:true,fillColor:{colors:[{opacity:1},{opacity:1}]},},points:{width:0.1,show:false},},grid:{show:false,borderWidth:0},legend:{show:false,}});var g={labels:["一月","二月","三月","四月","五月","六月","七月"],datasets:[{label:"示例数据",fillColor:"rgba(220,220,220,0.5)",strokeColor:"rgba(220,220,220,1)",pointColor:"rgba(220,220,220,1)",pointStrokeColor:"#fff",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(220,220,220,1)",data:[65,59,40,51,36,25,40]},{label:"示例数据",fillColor:"rgba(26,179,148,0.5)",strokeColor:"rgba(26,179,148,0.7)",pointColor:"rgba(26,179,148,1)",pointStrokeColor:"#fff",pointHighlightFill:"#fff",pointHighlightStroke:"rgba(26,179,148,1)",data:[48,48,60,39,56,37,30]}]};var d={scaleShowGridLines:true,scaleGridLineColor:"rgba(0,0,0,.05)",scaleGridLineWidth:1,bezierCurve:true,bezierCurveTension:0.4,pointDot:true,pointDotRadius:4,pointDotStrokeWidth:1,pointHitDetectionRadius:20,datasetStroke:true,datasetStrokeWidth:2,datasetFill:true,responsive:true,};var b=document.getElementById("lineChart").getContext("2d");var c=new Chart(b).Line(g,d)});
</script>
